    ...
    <div class="page-bar">
        <div class="page-title-breadcrumb">
            ...
            <ol class="breadcrumb page-breadcrumb pull-right">
                ...
                <li class="active"><a href="{{ route('admin.jenis_barang') }}">Jenis Barang</a></li>
            </ol>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-topline-red">
                <div class="card-head">
                    <header>Daftar Jenis Barang</header>
                </div>
                <div class="card-body ">
                    <div class="row p-b-20">
                        <div class="col-md-6 col-sm-6 col-6">
                            <div class="btn-group">
                                <a href="{{ route('admin.jenis_barang.create') }}" class="btn btn-info">
                                    Tambah Jenis Barang <i class="fa fa-plus"></i>
                                </a>
                            </div>
                        </div>
                    </div>
